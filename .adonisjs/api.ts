...
type RegisterPost = {
  request: MakeTuyauRequest<
    InferInput<(typeof import('../app/validators/registered_user.ts'))['createRegisteredUserValidator']>
  >
...
type LoginGetHead = {
  ...
  response: MakeTuyauResponse<
    import('../app/controllers/Auth/authenticated_session_controller.ts').default['create'],
    false
  >
}
type LoginPost = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/Auth/authenticated_session_controller.ts').default['store'],
    false
  >
}
type LogoutDelete = {
  request: unknown
  response: MakeTuyauResponse<
    import('../app/controllers/Auth/authenticated_session_controller.ts').default['destroy'],
    false
  >
}
